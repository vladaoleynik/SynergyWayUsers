...
INSERT INTO "user" (
  name, email, mobile, phone, status
    ...
    ('King', 'king@email.com', '380960248369', NULL, FALSE),
    ('Poe', 'poe@email.com', NULL, NULL, TRUE),
    ('Tolkien', 'tolkien@email.com', NULL, NULL, FALSE),
    ('Martin', 'martin@email.com', NULL, NULL, FALSE),
    ('Azimov', 'azimov@email.com', NULL, NULL, TRUE),
    ('Dickens', 'dickens@email.com', NULL, NULL, FALSE),
    ('Lovecraft', 'lovecraft@email.com', NULL, NULL, FALSE),
    ('Tolstoy', 'tolstoy@email.com', NULL, NULL, FALSE),
    ('Derlet', 'derlet@email.com', NULL, NULL, FALSE),
    ('Smith', 'smith@email.com', NULL, NULL, TRUE),
    ('Fitzgerald', 'fitzgerald@email.com', NULL, NULL, TRUE),
    ('Remarque', 'remarque@email.com', NULL, NULL, FALSE),
    ('Tarantino', 'tarantino@email.com', NULL, NULL, FALSE),
    ('Burton', 'burton@email.com', NULL, NULL, TRUE),
    ('DeepPurple', 'purple@email.com', NULL, NULL, TRUE),
    ('DefLeppard', 'leppard@email.com', NULL, NULL, FALSE),
    ('Dirkschneider', 'dirkschneider@email.com', NULL, NULL, FALSE),
    ('ZZTop', 'zz_top@email.com', NULL, NULL, TRUE),
    ('ACDC', 'ac_dc@email.com', NULL, NULL, TRUE),
